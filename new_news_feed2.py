...
for k in range (0,len(w)-1):
	...
	for valresp in response['articles']:
		...
		#print image					
			...
			keyword=["Business", "Technology", "Climate","Agriculture", "Sports", "Energy", "People","Entertainment", "Electronics", "finance", "Auditing", "Banking", "Insurance", "Magazines", "Real Estate", "Investment", "Manufacturing", "Security", "Small Business", "Marketing",
